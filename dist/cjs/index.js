...
const getContainerRect = (0, _memoizeOne.default)(
  (element, width, top) => [
    {
      width,
      top,
...
const assignUserItemStyle = (0, _trieMemoize.default)(
...
const getCachedSize = (0, _memoizeOne.default)(
  (width) => ({
    width,
    zIndex: -1000,
    visibility: 'hidden',
...
const getCachedItemStyle = (0, _trieMemoize.default)(
  [_oneKeyMap.default, Map, Map],
  (width, left, top) => ({
    top,
    left,
    width,
...
const getRefSetter = (0, _trieMemoize.default)(
  [_oneKeyMap.default, _oneKeyMap.default, _oneKeyMap.default],
...
const Masonry = /*#__PURE__*/ _react.default.memo(
