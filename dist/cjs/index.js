...
FreeMasonry.propTypes = {
  ...
  itemStyle: _propTypes.default.any,
  ...
  containerRef: _propTypes.default.oneOfType([_propTypes.default.func, _propTypes.default.any])
};

const Masonry = _react.default.memo(_react.default.forwardRef((props, ref) => {
  const {
    width,
    height,
    scrollY,
